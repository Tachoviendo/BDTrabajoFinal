...
import { Pozo, NivelAporte, Usuario } from "../models/schemas.js";
import * as err from "../models/errors.js";
import { NivelAporteBody } from "../models/schemas.js";
import * as func from "../services/niveles-aporte-services.js";
const nivelesAporteRoutes = async function (fastify, options) {
    //Crear un intervalo para niveles de aporte
    fastify.post("/usuarios/:id_usuario/pozos/:id_pozo/niveles_aporte", {
        schema: {
    ...
    fastify.put("/usuarios/:id_usuario/pozos/:id_pozo/niveles_aporte/:id_nivel_aporte", {
        schema: {
        ...
        try {
            const { id_pozo, id_nivel_aporte } = req.params;
            const data = req.body;
            const pozoEditado = await func.updateNivelAporte(id_pozo, id_nivel_aporte, data);
            if (!pozoEditado)
                throw new err.T05PozoNoEncontrado();
    ...
    fastify.delete("/usuarios/:id_usuario/pozos/:id_pozo/niveles_aporte/:id_nivel_aporte", {
        schema: {
        ...
        try {
            const { id_pozo, id_nivel_aporte } = req.params;
            const nivelAporteBorrado = await func.deleteNivelAporte(id_pozo, id_nivel_aporte);
            if (!nivelAporteBorrado)
                throw new err.T05PozoNoEncontrado();
    ...
    fastify.get("/usuarios/:id_usuario/pozos/:id_pozo/niveles_aporte/:id_nivel_aporte", {
        schema: {
        ...
        try {
            const { id_pozo, id_nivel_aporte } = req.params;
            const nivelAporte = await func.getNivelAporteById(id_pozo, id_nivel_aporte);
            if (!nivelAporte)
                throw new err.T05PozoNoEncontrado();
    ...
    fastify.get("/usuarios/:id_usuario/pozos/:id_pozo/niveles_aporte", {
        schema: {
        ...
        try {
            const { id_pozo } = req.params;
            const listaAporte = await func.getNivelAporteList(id_pozo);
...
//# sourceMappingURL=niveles-aporte.js.map