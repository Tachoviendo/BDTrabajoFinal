...
import { Rol, RolBody } from "../models/schemas.js";
import * as err from "../models/errors.js";
import * as func from "../services/roles-services.js";
const rolesRoutes = async function (fastify, options) {
    //Crear un rol
    fastify.post("/roles", {
        schema: {
