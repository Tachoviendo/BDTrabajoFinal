...
import { Usuario, Rol, UsuarioBody } from "../models/schemas.js";
import * as err from "../models/errors.js";
import * as func from "../services/usuarios-service.js";
import * as rolfunc from "../services/roles-services.js";
import { clientConnections } from "../plugins/websocket.js";
const usuariosRoutes = async function (fastify, options) {
    ...
    fastify.put("/usuarios/:id_usuario/roles/:id_rol", {
        schema: {
    ...
    fastify.get("/usuarios/:id_usuario/roles", {
        schema: {
